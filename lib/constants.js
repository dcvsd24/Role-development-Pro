...
var Constants = {
    ...
    SCRIPT_COOLDOWN_RECORD: "script_cooldown_record.json",
    ...
    // 错误提示
    ERROR_NO_SCRIPTS: "⚠️ 未找到任何JSON路径脚本！请右键点击脚本。打开脚本所在目录,鼠标左键双击运行 SymLink.bat ，以创建文件夹链接pathing文件",
    ERROR_NO_PATHING: "⚠️请确保地图追踪 地方特产和敌人与魔物，已订阅或更新路径",
